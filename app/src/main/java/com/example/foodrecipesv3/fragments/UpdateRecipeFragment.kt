...
class UpdateRecipeFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(recipeId: String): UpdateRecipeFragment {
            val fragment = UpdateRecipeFragment()
            val args = Bundle()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recipeId = arguments?.getString(ARG_RECIPE_ID) ?: throw IllegalArgumentException("Recipe ID must be passed to UpdateRecipeFragment")
    }
